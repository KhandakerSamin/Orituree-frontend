    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium text-white leading-tight max-w-4xl mx-auto px-2 sm:px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 xl:gap-12 mb-8 sm:mb-12 lg:mb-16">
          {recentCaseStudies.map((study) => (
            <div
              key={study.id}
              className="group relative rounded-2xl sm:rounded-3xl overflow-hidden transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-white/10 bg-gray-900/20 backdrop-blur-sm"
            >
              {/* Case Study Image */}
              <div className="relative h-48 sm:h-56 md:h-64 lg:h-72 xl:h-80 overflow-hidden rounded-t-2xl sm:rounded-t-3xl">
                <Image
                  src={study.image}
                  alt={study.title}
                  fill
                ...
                {/* Image Placeholder */}
                <div className="w-full h-full bg-gray-700 flex items-center justify-center text-gray-400 text-sm hidden rounded-t-2xl sm:rounded-t-3xl">
                  Case Study Image
                </div>
              </div>

              {/* Case Study Details */}
              <div className="p-4 sm:p-5 md:p-6 lg:p-8 rounded-b-2xl sm:rounded-b-3xl">
                ...
                <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-white leading-tight group-hover:text-[#D1FF52] transition-colors duration-300 pr-2">
                  {study.title}
                </h3>
              </div>

              {/* Hover Overlay only on image */}
              <div className="absolute inset-x-0 top-0 h-48 sm:h-56 md:h-64 lg:h-72 xl:h-80 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none rounded-t-2xl sm:rounded-t-3xl"></div>
            </div>
          ))}
        </div>
        ...
        <div className="flex items-center justify-center">
          ...
          <div className="hidden md:flex items-center justify-center space-x-4 group max-w-[380px] w-full">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-10 sm:-top-20 lg:-top-40 -right-10 sm:-right-20 lg:-right-40 w-20 sm:w-40 lg:w-80 h-20 sm:h-40 lg:h-80 bg-[#D1FF52]/5 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-10 sm:-bottom-20 lg:-bottom-40 -left-10 sm:-left-20 lg:-left-40 w-20 sm:w-40 lg:w-80 h-20 sm:h-40 lg:h-80 bg-blue-500/5 rounded-full blur-2xl sm:blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
    </section>
  );
};
